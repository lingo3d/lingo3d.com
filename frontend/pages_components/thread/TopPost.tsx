        ...
        <Box sx={{ marginTop: "25px" }} className="mt-[25px] textColor2 borderBottom pb-4">
            ...
            <div className="flex justify-start items-center">
                ...
                <div className="flex flex-col mx-[8px]">
                    <div className="font-bold text-[15px] my-1">{data.data.attributes.username}</div>
            ...
            <div className="flex justify-end items-center mt-[20px]">
                ...
                <ReplyIcon
                    ...
                    onClick={() => activateReply(data.data.attributes.description, data.data.attributes.username)}
                />
            </div>
